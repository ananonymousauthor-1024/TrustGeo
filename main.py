...
if __name__ == '__main__':
    ...
    for epoch in range(2000):
        ...
        for i in range(len(train_data)):
            ...
            # New_York
            loss = NIG_loss(y_pred_g, v_g, alpha_g, beta_g, mse_loss, coeffi=7e-3) + \
                   NIG_loss(y_pred_a, v_a, alpha_a, beta_a, mse_loss, coeffi=7e-3) + \
                   NIG_loss(y_pred_f, v_f, alpha_f, beta_f, mse_loss, coeffi=7e-3)
